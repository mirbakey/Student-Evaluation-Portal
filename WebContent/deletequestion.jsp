...
<div id="container">
	...
	<%			
		...
		if (validity.equals("truetrue")) {			
			...
			<div id="blocks">
			<h3 class="fie">Delete Question</h3>
			<form action="deletequestionfinal.jsp" method="post">
			<table>
			<tr><th>S.No</th><th>Question</th><th>Selection</th></tr>
			<%int i=0;
			while(rs.next())
			{
				...
				<tr><td><%=i %></td><td><%=s%></td><td><input type="radio" value=<%=sd%> name="question" required></td></tr>
