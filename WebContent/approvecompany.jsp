...
<div id="container">
	...
	<%			
		...
		if (validity.equals("truetrue")) {			
			...
			<div id="blocks">
			<h3 class="fie">List Of Unapproved Companies </h3>
			<h4 class="fie">Select To Approve Company</h4>
			
			<form action="approvecompanyfinal.jsp" method="post">
			<table>
			<tr><th>Name</th><th>Email</th><th>Selection</th></tr>
			<%while(rs.next())
			{
				...
				<tr><td><%=name %></td><td><%=compEmail%></td><td><input type="radio" value=<%=compEmail%> name="approval" required></td></tr>
